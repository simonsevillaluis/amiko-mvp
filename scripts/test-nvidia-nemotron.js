...
async function testNvidiaNemotron() {
  ...
  console.log(`🔑 Clave detectada. Conectando con Nemotron-3 en NVIDIA NIM (${modelName})...`);
  ...
  try {
    ...
    console.log('✅ Respuesta recibida exitosamente de Nemotron en NVIDIA!\n');
    console.log('--- JSON Adaptado ---');
    console.log(JSON.stringify(JSON.parse(content), null, 2));
    console.log('---------------------');
  } catch (err) {
    console.error('\n❌ Falló la conexión con Nemotron en NVIDIA:');
